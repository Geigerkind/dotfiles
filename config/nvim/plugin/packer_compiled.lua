...
local package_path_str = "/home/shino/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?.lua;/home/shino/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?/init.lua;/home/shino/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?.lua;/home/shino/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?/init.lua"
local install_cpath_pattern = "/home/shino/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/lua/5.1/?.so"
...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/home/shino/.local/share/nvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
    config = { "\27LJ\2\nF\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\fcomment\27plugins.configs.others\frequire\0" },
    keys = { { "", "gc" }, { "", "gb" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/Comment.nvim",
  ...
  LuaSnip = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/LuaSnip",
  ...
  ["cmp-buffer"] = {
    after = { "cmp-path" },
    after_files = { "/home/shino/.local/share/nvim/site/pack/packer/opt/cmp-buffer/after/plugin/cmp_buffer.lua" },
    load_after = {
      ["cmp-nvim-lsp"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/cmp-buffer",
    url = "https://github.com/hrsh7th/cmp-buffer"
  },
  ["cmp-nvim-lsp"] = {
    after = { "cmp-buffer" },
    after_files = { "/home/shino/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp/after/plugin/cmp_nvim_lsp.lua" },
    load_after = {
      ["cmp-nvim-lua"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp",
    url = "https://github.com/hrsh7th/cmp-nvim-lsp"
  },
  ["cmp-nvim-lua"] = {
    after = { "cmp-nvim-lsp" },
    after_files = { "/home/shino/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua/after/plugin/cmp_nvim_lua.lua" },
    load_after = {
      cmp_luasnip = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua",
    url = "https://github.com/hrsh7th/cmp-nvim-lua"
  },
  ["cmp-path"] = {
    after_files = { "/home/shino/.local/share/nvim/site/pack/packer/opt/cmp-path/after/plugin/cmp_path.lua" },
    load_after = {
      ["cmp-buffer"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/cmp-path",
    url = "https://github.com/hrsh7th/cmp-path"
  },
  cmp_luasnip = {
    after = { "cmp-nvim-lua" },
    after_files = { "/home/shino/.local/share/nvim/site/pack/packer/opt/cmp_luasnip/after/plugin/cmp_luasnip.lua" },
    load_after = {
      LuaSnip = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/cmp_luasnip",
  ...
  extensions = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/extensions",
  ...
  ["friendly-snippets"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/friendly-snippets",
  ...
  ["gitsigns.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/gitsigns.nvim",
  ...
  ["indent-blankline.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/indent-blankline.nvim",
  ...
  ["nvim-autopairs"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/nvim-autopairs",
  ...
  ["nvim-cmp"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/nvim-cmp",
  ...
  ["nvim-colorizer.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/nvim-colorizer.lua",
  ...
  ["nvim-lsp-installer"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/nvim-lsp-installer",
  ...
  ["nvim-lspconfig"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/nvim-lspconfig",
  ...
  ["nvim-tree.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/nvim-tree.lua",
  ...
  ["nvim-treesitter"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/nvim-treesitter",
  ...
  ["nvim-web-devicons"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  nvterm = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/nvterm",
    url = "https://github.com/NvChad/nvterm"
  },
  ["packer.nvim"] = {
    loaded = true,
    path = "/home/shino/.local/share/nvim/site/pack/packer/start/packer.nvim",
  ...
  ["plenary.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/plenary.nvim",
  ...
  ["telescope.nvim"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/telescope.nvim",
  ...
  ui = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/ui",
  ...
  ["which-key.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/shino/.local/share/nvim/site/pack/packer/opt/which-key.nvim",
